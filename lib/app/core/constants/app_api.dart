...
class AppApi {
  ...
  static String tripTracking(String uuid)  => '/trips/$uuid/tracking';
  static String tripComplete(String uuid)  => '/trips/$uuid/complete';
  static const String passengerActiveBookings = '/passenger/bookings';
  ...
  static String syncPayment(String paymentUuid)        => '/payments/$paymentUuid/sync';
  static String confirmArrival(String bookingUuid) => '/bookings/$bookingUuid/confirm-arrival';
  static String confirmPickup(String bookingUuid) => '/passenger/bookings/$bookingUuid/pickup-confirm';
