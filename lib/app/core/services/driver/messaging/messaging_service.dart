...
abstract class MessagingService {
  ...
  /// Crée ou récupère la conversation liée à une réservation (conducteur).
  Future<ApiResult<String>> startConversation(String bookingUuid);

  /// Supprime définitivement un message (conducteur). Seul l'expéditeur peut agir.
  Future<ApiResult<void>> deleteMessage(String messageUuid);

  /// Modifie le texte d'un message (conducteur). Seul l'expéditeur peut agir.
