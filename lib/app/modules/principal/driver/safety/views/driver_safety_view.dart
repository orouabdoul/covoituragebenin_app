      ...
      child: Container(
        ...
        child: Column(
          children: [
            ...
            Text('SOS', style: AppTextStyles.h3(r).copyWith(color: Colors.white, fontWeight: FontWeight.w900)),
            SizedBox(height: r.adaptive(phone: 6, smallPhone: 5, tablet: 7, desktop: 8)),
            Text('Appuyez pour contacter les secours',
                style: AppTextStyles.bodySmall(r).copyWith(color: Colors.white.withOpacity(0.85))),
          ],
        ),
      ),
    );
            ...
            children: [
              Container(
                ...
                child: Icon(
                  ...
                  color: controller.isSharingLocation.value ? AppColors.success : AppColors.textMuted,
                ),
              ),
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      child: Column(
        children: [
          _ActionRow(
            r: r, icon: Icons.headset_mic_rounded, label: 'Appeler le support MINIZON',
            color: AppColors.primary, onTap: controller.onCallSupport, isLast: false,
          ),
          _ActionRow(
            r: r, icon: Icons.flag_rounded, label: 'Signaler un incident',
            color: AppColors.warning, onTap: controller.onReportIncident, isLast: true,
          ),
        ],
      ),
    );
...
class _ActionRow extends StatelessWidget {
  const _ActionRow({required this.r, required this.icon, required this.label, required this.color, required this.onTap, required this.isLast});
  final AppResponsive r;
  final IconData icon;
  final String label;
  final Color color;
  ...
  Widget build(BuildContext context) {
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Row(
          children: [
            Icon(icon, size: r.adaptive(phone: 22, smallPhone: 20, tablet: 24, desktop: 26), color: color),
            SizedBox(width: r.adaptive(phone: 14, smallPhone: 12, tablet: 16, desktop: 18)),
            Expanded(
              child: Text(label,
                  style: AppTextStyles.bodySmall(r).copyWith(
      ...
      child: Column(
        ...
        children: [
          Text("Numéros d'urgence",
              style: AppTextStyles.homeCardTitle(r).copyWith(color: const Color(0xFFDC2626))),
          SizedBox(height: r.adaptive(phone: 12, smallPhone: 10, tablet: 14, desktop: 16)),
          Row(
