...
class EditTrajetView extends GetView<EditTrajetController> {
  const EditTrajetView({super.key});
...
class _HeroSection extends StatelessWidget {
  ...
  final AppResponsive responsive;
  final EditTrajetController controller;
        ...
        children: [
          Container(
            ...
            child: Icon(Icons.edit_road_rounded,
                color: AppColors.white, size: responsive.text(28)),
          ),
          SizedBox(height: responsive.h(16)),
          Text(
                ...
                children: [
                  ...
                  Text(
                    ...
                    style: AppTextStyles.profileSectionTitle(responsive).copyWith(
                        color: AppColors.white, fontSize: responsive.text(18)),
                  ),
                ],
              ),
            );
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      final List<String> districts =
          controller.getQuartiers(selectedCity, selectedArr);
      ...
      return Column(
        ...
        children: [
          ...
          SizedBox(height: responsive.h(12)),
          _LocationAutocompleteField(
            key: ValueKey('${isDeparture ? "dep" : "dest"}-arr-$selectedCity'),
            responsive: responsive,
          ...
          SizedBox(height: responsive.h(12)),
          _LocationAutocompleteField(
            key: ValueKey('${isDeparture ? "dep" : "dest"}-district-$selectedCity-$selectedArr'),
            responsive: responsive,
            label: 'Quartier',
            controller: isDeparture
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          decoration: ShapeDecoration(
            color:
                widget.enabled ? AppColors.surface : AppColors.surfaceSoft,
            shape: RoundedRectangleBorder(
              side: BorderSide(
                width: 2,
                color: isInvalid
            ...
            children: [
              ...
              if (widget.isSelected)
                Icon(Icons.check_circle_rounded,
                    color: AppColors.primary, size: widget.responsive.text(18))
              else if (isInvalid)
                Icon(Icons.error_outline_rounded,
                    color: AppColors.danger, size: widget.responsive.text(18))
              else
          ...
          if (_filtered.isNotEmpty)
            Container(
              ...
              child: ListView.builder(
                padding:
                    EdgeInsets.symmetric(vertical: widget.responsive.h(4)),
                shrinkWrap: true,
            ...
            children: [
              ...
              Text(
                ...
                style: AppTextStyles.caption(responsive).copyWith(
                  ...
                  fontWeight:
                      atMax ? FontWeight.w700 : FontWeight.w400,
                ),
              ),
            ],
          ),
              ...
              Expanded(
                child: TextField(
                  ...
                  decoration: InputDecoration(
                    ...
                    hintText: '5000',
                    hintStyle: AppTextStyles.muted(responsive)
                        .copyWith(fontSize: responsive.text(22)),
                  ),
                ),
              ),
              SizedBox(width: responsive.w(8)),
            ...
            child: Column(
              children: [
                Row(
                  ...
                  children: [
                    Text(
                      '$seats place${seats > 1 ? 's' : ''} × $price FCFA',
                      style: AppTextStyles.profileSectionLabel(responsive),
                    ),
                    Text(
                      '$total FCFA',
                ...
                Row(
                  ...
                  children: [
                    Text(
                      'Commission (${controller.commissionRatePercent}%)',
                      style: AppTextStyles.caption(responsive),
                    ),
                    Text('$fee FCFA',
                        style: AppTextStyles.caption(responsive)),
        ...
        return Container(
          ...
          child: Row(
            children: [
              ...
              Text('Calcul de la distance en cours…',
                  style: AppTextStyles.caption(responsive)),
            ],
          ),
        );
              ...
              children: [
                ...
                Expanded(
                  child: Container(
                    ...
                    padding:
                        EdgeInsets.symmetric(horizontal: responsive.w(10)),
...
class _PreferencesGrid extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(
      () => Column(
        children: controller.preferences.map((TripPreferenceData item) {
          final bool selected =
              controller.selectedOptions.contains(item.option);
          return Padding(
...
class _BookingModeSelector extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return Column(
        children: controller.bookingModes.map((BookingModeOption mode) {
...
class _CancellationPolicySelector extends StatelessWidget {
  const _CancellationPolicySelector(
      {required this.responsive, required this.controller});
  final AppResponsive responsive;
  final EditTrajetController controller;
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      ...
      return Column(
        children: controller.cancellationPolicies
            .map((CancellationPolicyOption policy) {
