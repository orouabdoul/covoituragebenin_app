                    ...
                    children: [
                      ...
                      ...controller.reviews.map(
                        (rev) => Padding(
                          ...
                          child: _ReviewCard(r: r, review: rev, controller: controller),
                        ),
                      ),
    ...
    return Container(
      ...
      child: Row(
        children: [
            ...
            children: [
              ...
              Row(
                children: List.generate(5, (i) => Icon(
                  i < controller.averageRating.floor() ? Icons.star_rounded : Icons.star_outline_rounded,
          ...
          SizedBox(width: r.adaptive(phone: 20, smallPhone: 16, tablet: 24, desktop: 28)),
          Expanded(
            child: Column(
              children: [5, 4, 3, 2, 1].map((star) {
                final ratio = controller.ratingDistribution[star] ?? 0.0;
                return Padding(
                  padding: EdgeInsets.only(bottom: r.adaptive(phone: 4, smallPhone: 3, tablet: 5, desktop: 6)),
                  child: Row(
                    children: [
                      Text('$star', style: AppTextStyles.labelSmall(r).copyWith(color: AppColors.textMuted, fontWeight: FontWeight.w600)),
...
class _ReviewCard extends StatelessWidget {
  const _ReviewCard({required this.r, required this.review, required this.controller});
  final AppResponsive r;
      ...
      child: Column(
        ...
        children: [
          ...
          if (review.comment != null) ...[
            SizedBox(height: r.adaptive(phone: 10, smallPhone: 8, tablet: 12, desktop: 14)),
            Text(review.comment!,
                style: AppTextStyles.bodySmall(r).copyWith(color: AppColors.textSecondary)),
          ],
          if (review.driverReply != null) ...[
            SizedBox(height: r.adaptive(phone: 10, smallPhone: 8, tablet: 12, desktop: 14)),
            Container(
              padding: EdgeInsets.all(r.adaptive(phone: 10, smallPhone: 8, tablet: 12, desktop: 14)),
              decoration: BoxDecoration(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Expanded(
                    child: Text(
                      review.driverReply!,
                      style: AppTextStyles.labelSmall(r).copyWith(color: AppColors.textSecondary),
                    ),
                  ),
                ],
              ),
