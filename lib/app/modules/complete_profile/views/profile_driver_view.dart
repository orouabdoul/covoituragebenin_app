...
import 'package:covoiturage_benin_app/app/modules/complete_profile/controllers/profile_driver_controller.dart';
                  ...
                  builder: (controller) {
                    return Column(
                      ...
                      children: [
                        ...
                        _ProgressCard(responsive: responsive, progress: controller.progress.value),
                        SizedBox(height: responsive.h(20)),
                          ...
                          child: Column(
                            children: [
                              AppField(
                                ...
                                child: Text(AppStrings.profileFieldLastNameHint, style: AppTextStyles.profileFieldValue(responsive)),
                              ),
                              ...
                              AppField(
                                ...
                                labelStyle: AppTextStyles.profileSectionLabel(responsive),
                                child: Text(AppStrings.profileFieldFirstNameHint, style: AppTextStyles.profileFieldValue(responsive)),
                              ),
                              SizedBox(height: responsive.h(16)),
                              AppField(
                                responsive: responsive,
                                ...
                                labelStyle: AppTextStyles.profileSectionLabel(responsive),
                                backgroundColor: const Color(0x0C00A86B),
                                borderColor: AppColors.primary,
                                child: Row(
                                  children: [
                                    Icon(Icons.verified_rounded, size: responsive.text(18), color: AppColors.primary),
                                    SizedBox(width: responsive.w(10)),
                                    Text('+229 01 97 45 67 89', style: AppTextStyles.profileFieldValue(responsive)),
                                  ],
                                ),
                                helperText: AppStrings.profileSectionPhoneVerified,
                                helperStyle: AppTextStyles.profileMeta(responsive).copyWith(color: AppColors.primary),
                              ),
                            ],
                          ),
                        ),
                        ...
                        _SectionCard(
                          ...
                          child: Column(
                            children: [
                              Row(
                                children: [
                                  Expanded(child: _ValueField(responsive: responsive, label: AppStrings.profileFieldVehicleBrand, value: AppStrings.profileVehicleBrandValue, filled: true)),
                                  SizedBox(width: responsive.w(12)),
                                  Expanded(child: _ValueField(responsive: responsive, label: AppStrings.profileFieldVehicleModel, value: AppStrings.profileVehicleModelValue)),
                                ],
                              ),
                              SizedBox(height: responsive.h(16)),
                              Row(
                                children: [
                                  Expanded(child: _ValueField(responsive: responsive, label: AppStrings.profileFieldVehicleColor, value: AppStrings.profileVehicleColorValue, filled: true)),
                                  SizedBox(width: responsive.w(12)),
                                  Expanded(child: _ValueField(responsive: responsive, label: AppStrings.profileFieldVehicleSeats, value: AppStrings.profileVehicleSeatsValue, filled: true)),
                                ],
                              ),
                              SizedBox(height: responsive.h(16)),
                              AppField(
                                ...
                                labelStyle: AppTextStyles.profileSectionLabel(responsive),
                                child: Text(AppStrings.profileVehiclePlateValue, style: AppTextStyles.profileFieldValue(responsive)),
                              ),
                            ],
                          ),
                        ),
                          ...
                          child: Column(
                            children: [
                              ...
                              _DocumentUploadTile(
                                ...
                                subtitle: AppStrings.profileFieldRegistrationHint,
        ...
        Row(
          children: [
            Container(
              ...
              child: Center(
                child: Text('M', style: AppTextStyles.profileSectionTitle(responsive).copyWith(color: Colors.white, fontSize: responsive.text(16))),
              ),
            ),
    ...
    return Column(
      ...
      children: [
        ...
        ClipRRect(
          ...
          child: Stack(
            children: [
              Container(height: responsive.h(8), color: const Color(0xFFE5E7EB)),
              FractionallySizedBox(
                widthFactor: progress / 100,
                child: Container(height: responsive.h(8), decoration: const BoxDecoration(gradient: LinearGradient(colors: [Color(0xFF00A86B), Color(0xFFF4B400)]))),
              ),
            ],
          ),
        ),
...
class _HeroCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      decoration: ShapeDecoration(
        gradient: const LinearGradient(begin: Alignment.topLeft, end: Alignment.bottomRight, colors: [Color(0xFF00A86B), Color(0xFF008F5A)]),
        ...
        children: [
          Row(
            children: [
              Container(
                ...
                decoration: BoxDecoration(color: Colors.white.withValues(alpha: 0.20), borderRadius: BorderRadius.circular(responsive.radius(16))),
                child: Icon(Icons.verified_outlined, color: Colors.white, size: responsive.text(28)),
              ),
          ...
          Row(
            children: [
              ...
              SizedBox(width: responsive.w(8)),
              Text(AppStrings.profileHeroTime, style: AppTextStyles.profileHeroSubtitle(responsive).copyWith(fontWeight: FontWeight.w500)),
            ],
          ),
        ],
      ),
...
class _SectionCard extends StatelessWidget {
  const _SectionCard({required this.responsive, required this.title, required this.icon, required this.child});
...
class _ValueField extends StatelessWidget {
  const _ValueField({required this.responsive, required this.label, required this.value, this.filled = false});
  ...
  Widget build(BuildContext context) {
    return AppField(
      ...
      label: label,
      labelStyle: AppTextStyles.profileSectionLabel(responsive),
      backgroundColor: filled ? const Color(0xFFEFEFEF) : Colors.white,
      child: Text(value, style: AppTextStyles.profileFieldValue(responsive)),
    );
  }
}
    ...
    return AppField(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(title, textAlign: TextAlign.center, style: AppTextStyles.profileSectionTitle(responsive).copyWith(fontSize: responsive.text(16))),
          SizedBox(height: responsive.h(4)),
...
class _TrustCard extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      padding: EdgeInsets.all(responsive.w(24)),
      decoration: ShapeDecoration(
        gradient: const LinearGradient(begin: Alignment(-0.00, 0.50), end: Alignment(1.00, 0.50), colors: [Color(0x0C00A86B), Color(0x0CF4B400)]),
        shape: RoundedRectangleBorder(
          side: const BorderSide(width: 1, color: Color(0x3300A86B)),
          borderRadius: BorderRadius.circular(responsive.radius(24)),
        ),
      ),
      child: Row(
